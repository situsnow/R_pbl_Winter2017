...
install.packages("devtools") # package development tools
library(devtools)
...
install.packages("clusterCrit") # clustering algoirthms
...
# We conducted unsupervised learning on a known data set. This is the real numbe rof clusters. 
ggplot(poke) + geom_point(aes(x=Type.1, y=Type.2, colour=factor(Type.1)))